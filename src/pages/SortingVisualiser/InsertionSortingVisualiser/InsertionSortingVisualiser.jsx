...
import "./InsertionSortingVisualiser.css";
import { getInsertionSortAnimations } from "./InsertionSortingAlgorithm.js";
...
const InsertionSortingVisualiser = () => {
  ...
  const insertionSort = () => {
    const allSteps = getInsertionSortAnimations(array);
...
export default InsertionSortingVisualiser;
